...
MY_DLL_API int __cdecl Dll_SetUserTimeRestriction(const char *userName, const char *weekDays, const char *timeInterval);
MY_DLL_API int __cdecl Dll_CreateWorkingFolderTree(void);
MY_DLL_API int __cdecl Dll_ComputeAndDistributePoints(float F, float x0, float xn, float dx);
